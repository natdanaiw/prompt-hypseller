...
$(document).ready(function () {
    ...
    $('#promptpay_tool,#image_output').css('display', 'none');
    ...
    $('#confirm').click(function () {
        ...
        $("html, body").animate({
            scrollTop: $("#canvas_result").offset().top
        }, 600);
...
function onImageInput() {
    $('#promptpay_tool,#confirm').css('display', 'block');
    $('#receiver').focus();
...
function drawImageActualSize() {
    ...
    if (qr_img != null) {
        ...
        $('#output_image').css('display', 'inline-block');
        $('#output_image').attr('src', canvas.toDataURL('image/png'));
